...
// Logging Callback
typedef void (*calypso_framework_renderer_pixel_opengl_log_callback_t)(const char* log_msg, const Uint8 log_type);
...
* \return void
*/
void calypso_framework_renderer_pixel_opengl_do_log_callback(const char* log_msg, const Uint8 log_type)
{
...
* \return unsigned int
*/
unsigned int calypso_framework_renderer_pixel_opengl_compile_shader(const char* shader_source, unsigned int shader_type)
{
    ...
    if (shader_compile_result == 0)
    {
        ...
        if (shader_type == GL_VERTEX_SHADER)
            calypso_framework_renderer_pixel_opengl_do_log_callback("Render: Vertex Shader (ERROR)\n",3);
        if (shader_type == GL_FRAGMENT_SHADER)
            calypso_framework_renderer_pixel_opengl_do_log_callback("Render: Fragment Shader (ERROR)\n",3);
        calypso_framework_renderer_pixel_opengl_do_log_callback(log_message,3);
...
* \return unsigned int
*/
unsigned int calypso_framework_renderer_pixel_opengl_create_shader_program_from_source(const char* vertex_shader_source, const char* fragment_shader_source)
{
    // Compile Shaders (Intermidete Data For Shaders)
    unsigned int vertex_shader = calypso_framework_renderer_pixel_opengl_compile_shader(vertex_shader_source, GL_VERTEX_SHADER);
    unsigned int fragment_shader = calypso_framework_renderer_pixel_opengl_compile_shader(fragment_shader_source, GL_FRAGMENT_SHADER);
...
* \return unsigned int
*/
unsigned int calypso_framework_renderer_pixel_opengl_create_default_shader_program()
{
    ...
    "\n"
    "uniform mat4 projectionView_in;\n"
    ...
    // Create Shader
    return calypso_framework_renderer_pixel_opengl_create_shader_program_from_source(vertex_shader_source,fragment_shader_source);
}
...
* \return void
*/
void calypso_framework_renderer_pixel_opengl_set_current_render_shader_program(const unsigned shader_program)
{
    glUseProgram(shader_program);
    calypso_framework_renderer_pixel_opengl_current_program = shader_program;
}
...
* \return void
*/
void calypso_framework_renderer_pixel_opengl_set_current_shader_program_parameter_float(char* paramter_name, const float v0)
{
    int location = glGetUniformLocation(calypso_framework_renderer_pixel_opengl_current_program,paramter_name);
    if (location == -1)
    {
        calypso_framework_renderer_pixel_opengl_do_log_callback("Renderer: Can't set shader program paramater vec3(",2);
        calypso_framework_renderer_pixel_opengl_do_log_callback(paramter_name,2);
        calypso_framework_renderer_pixel_opengl_do_log_callback(")\n",2);
        return;
    }
...
* \return void
*/
void calypso_framework_renderer_pixel_opengl_set_current_shader_program_parameter_vec2f(char* paramter_name, const float v0, const float v1)
{
    int location = glGetUniformLocation(calypso_framework_renderer_pixel_opengl_current_program,paramter_name);
    if (location == -1)
    {
...
* \return void
*/
void calypso_framework_renderer_pixel_opengl_set_current_shader_program_parameter_vec3f(char* paramter_name, const float v0, const float v1, const float v2)
{
    int location = glGetUniformLocation(calypso_framework_renderer_pixel_opengl_current_program,paramter_name);
    if (location == -1)
    {
...
* \return void
*/
void calypso_framework_renderer_pixel_opengl_set_current_shader_program_parameter_vec4f(char* paramter_name, const float v0, const float v1, const float v2, const float v3)
{
    int location = glGetUniformLocation(calypso_framework_renderer_pixel_opengl_current_program,paramter_name);
    if (location == -1)
    {
        calypso_framework_renderer_pixel_opengl_do_log_callback("Renderer: Can't set shader program paramater vec4(",2);
        calypso_framework_renderer_pixel_opengl_do_log_callback(paramter_name,2);
        calypso_framework_renderer_pixel_opengl_do_log_callback(")\n",2);
        return;
    }
...
* \return void
*/
void calypso_framework_renderer_pixel_opengl_set_current_shader_program_parameter_matrix4f(char* paramter_name, float matrix4f[4][4])
{
    int location = glGetUniformLocation(calypso_framework_renderer_pixel_opengl_current_program,paramter_name);
    if (location == -1)
    {
        calypso_framework_renderer_pixel_opengl_do_log_callback("Renderer: Can't set shader program paramater mat4f(",2);
        calypso_framework_renderer_pixel_opengl_do_log_callback(paramter_name,2);
        calypso_framework_renderer_pixel_opengl_do_log_callback(")\n",2);
        return;
    }
...
* \return void
*/
void calypso_framework_renderer_pixel_opengl_set_clear_color_by_byte_color_array(const Uint8 color_array[4])
{
