...
int main(int argc, char** argv)
{
    ...
    calypso_framework_app_sdl_init_window_with_opengl(CALYPSO_FRAMEWORK_RENDERER_OPENGL_MAJOR_VERSION,CALYPSO_FRAMEWORK_RENDERER_OPENGL_MINOR_VERSION,CALYPSO_FRAMEWORK_RENDERER_OPENGL_CONTEXT_PROFILE);
